...
```text
Use the organize-markdown-knowledge-base skill to audit this note repository, produce a dry-run organization plan, review weak relationships, and apply only the approved changes.
```
...
- filesystem write access only for `--apply`;
